...
- **Web3 Middleware Service Award (4,000 USDC for each competition, total 16,000 USDC）**
...
- **Security bug bounty (4,000 USDC for each competition, total 16,000 USDC)**

  An incentive for submitting effective bug reports on Alibaba Cloud's Nodeapi service.
  
- **DID applicability and compatibility (4,000 USDC for each competition, total 16,000 USDC)**
